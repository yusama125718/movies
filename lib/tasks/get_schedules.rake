    ...
    while(true)
      ...
      wait.until do
        active = driver.find_elements(
          ...
          ".calendar-slider li.calendar-active a[data-date='#{next_day_txt}'], "\
          ".calendar-slider li a.is-active[data-date='#{next_day_txt}'], "\
          ".calendar-slider li a.active[data-date='#{next_day_txt}']"
        ).any?
